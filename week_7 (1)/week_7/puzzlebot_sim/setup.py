...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'controller_bug0 = puzzlebot_sim.controller_bug0:main',
            'controller_bug2 = puzzlebot_sim.controller_bug2:main',
            'joint_state_publisher = puzzlebot_sim.joint_state_publisher:main',
            'localisation = puzzlebot_sim.localisation:main',
            'trajectory_generator = puzzlebot_sim.trajectory_generator:main',
        ],
    },
)